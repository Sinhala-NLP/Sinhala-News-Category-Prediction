...
model_args.save_steps = 600
model_args.train_batch_size = 16
model_args.wandb_project = "NSINa_category_prediction"
...
model = ClassificationModel(model_args.model_type, model_args.model_name, num_labels=4, use_cuda=torch.cuda.is_available(),
                     args=model_args)
